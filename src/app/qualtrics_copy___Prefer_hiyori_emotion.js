...
//          "https://cdn.jsdelivr.net/gh/NomaYasuo/AgentInteraction@f2b34407eebdb25349ff51d2ce3e8cb8b5d9ee58/js/IndexLibrary.js",
        ...
        //"https://cdn.jsdelivr.net/gh/edu-053/AgentInteractionResources@44910730de2d246983747ebc6be08dc5dddb3cee/js/IndexLibraryPerfectPrefarence_AModel.js",
    ];
                ...
                case "1":
                    switch (items.issue4.value){
                        ...
                        case 0:
                            ...
                            break;
                        case 1:
                            indexLibrary.App_set_point(3);
                            look_like[2] += 1;
                            break;
                        case 2:
                            indexLibrary.App_set_point(4);
                            look_like[3] += 1;
                            break;
                    }
                    look_img[0] += 1;
