...
//  const modelPath = "https://cdn.jsdelivr.net/gh/edu-053/AgentInteractionResources@39f3aed18d17f3ff893b842a2c5bef6e19af406e/Resources/Hiyori_free_2/hiyori_free_t08_2.model3.json";
    const modelPath = "https://cdn.jsdelivr.net/gh/edu-053/AgentInteractionResources@1d10ea0f2ed48612fe73ef7ad3d46e2b0ec61027/Resources/AModel/AModel/amodel.model3.json";
...
//        "https://e-sato.net/hiyori_3d_pixi/js/IndexLibrary.js",
        "https://cdn.jsdelivr.net/gh/edu-053/AgentInteractionResources@1d10ea0f2ed48612fe73ef7ad3d46e2b0ec61027/js/IndexLibrary_AModel_3Dtable.js",
    ];
...
/*********************************************表情制御？？？***************************************************/
    ...
    $('#item1').on('input change', function() {
        ...
        //App.tsに受け渡し用
        // console.log("index_limit",indexLibrary.limit);
        indexLibrary.set_agentpoint(total);/****************************set******************************/
        // console.log("index_total",indexLibrary.agent_point);
        indexLibrary.App_set_point();/****************************set******************************/
